  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form id="editProductForm" method="post" action="{{url('/admin/editProduct')}}" enctype="multipart/form-data">
            <input type="hidden" name="id" id="eid" >
              ...
              <div class="form-group">
                ...
                <textarea name="description" id="edit_description" cols="30" rows="10"  placeholder="Enter Description" class="form-control"></textarea>
              </div>
              ...
              <div class="form-group">
                <label class="edit_product_height">Product Height</label>
                    ...
                    <input type="text" class="form-control" name="product_height"
                        id="edit_product_height" required placeholder="Enter Product height" />
                ...
                <div class="form-group">
                    <label class="edit_product_breadth">Product Breadth</label>
                        ...
                        <input type="text" class="form-control" name="product_breadth"
                            id="edit_product_breadth" required placeholder="Enter Product Breadth" />
                ...
                <div class="form-group">
                  <label class="edit_product_length">Product Length</label>
                      ...
                      <input type="text" class="form-control" name="product_length"
                          id="edit_product_length" required placeholder="Enter Product length" />
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" data-dismiss="modal" onclick='FormReset("editProductForm")'>Close</button>
