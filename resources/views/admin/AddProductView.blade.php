                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                {{-- <input type="text" class="form-control" name="main_category" id="add_category"
                                                    ...
                                                    <select name="main_category" id="edit_category" required="" class="form-control" onchange="getDependent(event)">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <span style="color:#6c6666;font-size:16px;position:absolute;top:12px; right:40px;" id="cat_loader"></span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="product_breadth"
                                                    id="add_product_breadth" required placeholder="Enter Product Thickness" />
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Description</label>
                                                ...
                                                <textarea class="form-control" rows="10" cols="8" name="description" id="add_description"  placeholder="Enter Description"></textarea>
                                                @error('description')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
